...
public class WdwjApplication implements CommandLineRunner {
	...
	/*	dealershipService.addDealership(new Dealership("US name"));
		dealershipService.addDealership(new Dealership("EU name"));
		dealershipService.addDealership(new Dealership("UK name"));*/
		//System.out.println(dealershipService.getDealershipByName("US name"));
	}
}
